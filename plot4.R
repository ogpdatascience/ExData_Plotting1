...
par(mfrow=c(2,2))
#1
plot(dates,table_2days[,"Global_active_power"], type= "l", xlab= "", ylab = "Global Active Power")
#2
plot(dates,table_2days[,"Voltage"], type= "l", xlab= "datetime", ylab = "Voltage")
...
#4
plot(dates,table_2days[,"Global_reactive_power"], type= "l", xlab= "datetime", ylab = "Global Reactive Power")
